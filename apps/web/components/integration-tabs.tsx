  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
      <p className="text-zinc-300 text-sm mb-1">
        Search configs. Versioned. Community-driven.
      </p>
      ...
      <span className="inline-flex items-center gap-2 mt-4 text-sm text-zinc-500">
        ...
        <span className="text-[0.65rem] font-medium px-2 py-0.5 rounded-full bg-zinc-800 text-zinc-500">pending approval</span>
      </span>
    </div>
  );
}
